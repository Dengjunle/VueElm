    ...
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="favorite" @click="toggleFavorite($event)">
          <span class="iconfont icon-icon4" :class="{'active':favorite}"></span>
...
import {saveToLoval,loadFromLocal} from '../../common/js/store.js';
...
export default {
  ...
  methods: {
    toggleFavorite(event) {
      ...
      saveToLoval(this.seller.id,'favorite',this.favorite);
    },
    _initScroll() {
      if (!this.scroll) {
